...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/login/index.vue?vue&type=template&id=546a18f3&
...
// CONCATENATED MODULE: ./pages/login/index.vue?vue&type=template&id=546a18f3&
  ...
  methods: {
    ...
    async onSubmit() {
      try {
        ...
        console.log(data); // 将 data.user 存储到 store 中

        this.$store.commit("setUser", data.user); // 将 data.user 持久化
